              ...
              <div className="w-full md:w-[20vw] md:mx-2">
                <div className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 w-[20vw] p-3 border-t-4 border-green-400">
                  ...
                  <h3 className="text-gray-600 font-lg text-semibold leading-6">
                    {userDetails.user && userDetails.user.company
                  ...
                  <ul className="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 mt-3 divide-y rounded shadow-sm">
                    ...
                    <li className="flex items-center py-3 body-1">
                      <span className="body-1 flex w-full">Member since</span>
                      <span className="body-1 flex w-full">Nov 07, 2016</span>
                    </li>
                  </ul>
                </div>
                  ...
                  <div className="text-gray-700">
                    <div className="grid md:grid-cols-2 text-sm">
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">
                          {userDetails.user && userDetails.user.gender
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">
                          {userDetails.user && userDetails.user.phoneNumber
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">
                          {userDetails.user && userDetails.user.address
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">
                          <a
                            ...
                            href={`mailto: ${userDetails.user && userDetails.user.email ? userDetails.user.email : 'Nal'}`}
                          >
                      ...
                      <div className="grid grid-cols-2">
                        ...
                        <div className="px-4 py-2">{userDetails.user && userDetails.user.DOB ? userDetails.user.DOB : 'Feb 06, 1998'}</div>
                      </div>
                    </div>
                  </div>
